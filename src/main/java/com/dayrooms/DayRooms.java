...
import com.dayrooms.listeners.BlockTypeListener;
import com.dayrooms.listeners.CommandBlockListener;
import com.dayrooms.listeners.CommandBlockerListener;
...
import com.dayrooms.listeners.RoomPvpListener;
...
public class DayRooms extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("dayrooms").setTabCompleter(new DayRoomsTabCompleter(roomManager, messageManager));
        ...
        getServer().getPluginManager().registerEvents(new CommandBlockerListener(roomManager, selectionManager, messageManager), this);
        getServer().getPluginManager().registerEvents(new BlockTypeListener(roomManager, selectionManager), this);
        getServer().getPluginManager().registerEvents(new RoomPvpListener(roomManager), this);
